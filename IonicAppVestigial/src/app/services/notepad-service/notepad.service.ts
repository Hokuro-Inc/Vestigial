...
export class NotepadService {
  ...
  public getNotePads(data: string) {
    ...
    //return this.httpClient.post('https://localhost:8080/Vestigial/ShowBloc', data, { responseType:'text' });
  }
  ...
  public addNotePad(data: string) {
    ...
    //return this.httpClient.post('https://localhost:8080/Vestigial/AddBloc', data, { responseType:'text' });
  }
  ...
  public updateNotePad(data: string) {
    ...
    //return this.httpClient.post('https://localhost:8080/Vestigial/ModifyBloc', data, { responseType:'text' });
  }
  ...
  public removeNotePad(data: string) {
    ...
    //return this.httpClient.post('https://localhost:8080/Vestigial/RemoveBloc', data, { responseType:'text' });
  }
